...
export const deadOrAlive: Skill = {
  ...
  isInheritable: false,
  description:
    'Magic attack, 130 Neutral damage to one foe. 10% to inflict a status effect, 5% chance of instantly killing target.',
};
...
export const weltgeist: Skill = {
  ...
  isInheritable: false,
  description:
    'Nullify all received damage until the next turn, and counterattacks when receiving physical or magic attacks.',
};
