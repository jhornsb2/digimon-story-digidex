...
import * as skillMappings from './SkillMappings';
...
export const PUNIMON: Digimon = {
  ...
  name: 'Punimon',
  description:
    "A brand new type of Digimon. Three tentacles protrude from the top of its gelatinous, red body. It can't fight, but threatens enemies with acidic bubbles.",
  attribute: Attribute.Neutral,
  stage: Stage.Training1,
  type: DigimonType.Free,
  memoryUsage: 2,
...
export const BOTAMON: Digimon = {
  ...
  name: 'Botamon',
  description:
    "A newborn digital monster. Dark peach fuzz bristles across the surface of its slimy body. This new addition to the Digital World can't fight, but it can shoot bubbles from its mouth to intimidate foes.",
  attribute: Attribute.Neutral,
  stage: Stage.Training1,
  type: DigimonType.Free,
  memoryUsage: 2,
...
export const ARCADIAMON_IN_TR: Digimon = {
  ...
  skills: skillMappings.ARCADIAMON_IN_TR,
  digivolvesFrom: [],
  digivolvesTo: [],
...
export const KOROMON: Digimon = {
  ...
  name: 'Koromon',
  description:
    'This Digimon has shed its fur and grown one size bigger. It can move a bit faster, but fighting is still too much for it. It threatens enemies with bubbles from its mouth.',
...
export const TSUNOMON: Digimon = {
  ...
  name: 'Tsunomon',
  description:
    'A small Digimon like Punimon, but with one of the tentacles on its head hardened. It exhibits a more feral Digivolution than Punimon, and is covered in tufts of bushy hair. Its playful and mischievous personality remains, but it has yet to awaken to its combat ability.',
...
export const TSUMEMON: Digimon = {
  ...
  name: 'Tsumemon',
  description:
    'An in-training Digimon Digivolved from Kuramon. Its increased ferocity is met with new talons on the tips of its tentacles. It erodes data with dreadful speed, sending networks into disarray. High movement speed makes it difficult to capture when Digivolved into Tsumemon.',
  attribute: Attribute.Dark,
  stage: Stage.Training2,
  type: DigimonType.Free,
  memoryUsage: 3,
...
export const NYAROMON: Digimon = {
  ...
  name: 'Nyaromon',
  description:
    'A small Digimon with feline characteristics. Its capricious, cat-like behavior earned it the name Nyaromon. While both curious and fickle, it has a lonely side to it as well.',
...
export const BUKAMON: Digimon = {
  ...
  name: 'Bukamon',
  description:
    "This zany Digimon looks like a baby aquatic dinosaur, and moves like a sprightly seahorse. It tends to run away when others get close. Its exodermis can't withstand deep-sea water pressure or low temperatures, so it can't dive in the ocean depths for long.",
...
export const MOTIMON: Digimon = {
  ...
  name: 'Motimon',
  description:
    "A soft-bodied Digimon possessing an elastic outer skin, toddling along on the bumps under its torso. When it gets worked up, its body swells up like a mochi rice cake, earning it the name Motimon. Its appearance belies an above-average intelligence, which leads to the assumption that it was born from a computer's dictionary function. It understands human speech, and can sometimes be seen transforming its body to communicate.",
  attribute: Attribute.Neutral,
  stage: Stage.Training2,
  type: DigimonType.Free,
  memoryUsage: 3,
...
export const WANYAMON: Digimon = {
  ...
  name: 'Wanyamon',
  description:
    "A Digimon combining the data of small pets like dogs and cats. Its exceptional speed means you need to beware of it fleeing, but offering it an owner's affection makes it quite attached to you.",
...
export const AGUMON_BLK: Digimon = {
  ...
  skills: skillMappings.AGUMON_BLK,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 8,
...
export const ARCADIAMON_ROOKIE: Digimon = {
  ...
  equipmentSlots: 1,
  supportSkill: supportSkills.utopia,
  skills: skillMappings.ARCADIAMON_ROOKIE,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 6,
...
export const ARMADILLOMON: Digimon = {
  ...
  name: 'Armadillomon',
  description:
    'A mammal Digimon clad head to toe in a sturdy carapace. Easy-going and courteous, but sometimes pushes its luck. Armadillomon is a descendant of the same ancient species as Veemon, so it can perform a special armor Digivolution. Its special move Diamond Shell launches its curled-up body at the enemy.',
  attribute: Attribute.Earth,
  stage: Stage.Rookie,
  type: DigimonType.Free,
  memoryUsage: 4,
  ...
  skills: skillMappings.ARMADILLOMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 7,
...
export const IMPMON: Digimon = {
  ...
  name: 'Impmon',
  description:
    "A Rookie Digimon that looks like a demon child. This mischievous creature loves seeing the other guy squirm. Electrical appliances are said to go haywire when Impmon appears; so if your screen starts to bug out, it might be an Impmon prank. Despite its love of mischief and malice, this Digimon doesn't cow down to stronger creatures, instead facing them with its tough attitude. Even so, it also has a lonely side. Its signature move is Summon, which calls forth ice and flame elementals.",
  attribute: Attribute.Dark,
  stage: Stage.Rookie,
  type: DigimonType.Virus,
  memoryUsage: 5,
...
export const ELECMON: Digimon = {
  ...
  name: 'Elecmon',
  description:
    'A mammal Digimon with an incredibly inquisitive and naughty personality. Elecmon also has nine tails, which it spreads like a peacock in battle and uses to threaten the enemy. Its special move is Thunder Cloud.',
...
export const GAOMON: Digimon = {
  ...
  name: 'Gaomon',
  description:
    'A beast Digimon with sharp claws thought to be a subspecies of Gazimon. Its quick and nimble movements are perfect for hit-and-run tactics, and the gloves on each hand protect its claws until they grow out. It unleashes its special move Double Backhand while using its powerful leg strength to whirl around.',
  attribute: Attribute.Neutral,
  stage: Stage.Rookie,
  type: DigimonType.Data,
  memoryUsage: 5,
...
export const GABUMON: Digimon = {
  ...
  name: 'Gabumon',
  description:
    "Despite its fur pelt, this is a genuine reptile Digimon. It has a timid and shy personality, and always makes pelts out of Garurumon's leftover data to wear. Wearing the fur of a fearsome Digimon like Garurumon serves the purpose of protecting it. Its personality takes a 180 when it dons this fur. Its special move is Blue Blaster.",
  attribute: Attribute.Fire,
  stage: Stage.Rookie,
  type: DigimonType.Data,
  memoryUsage: 5,
...
export const GABUMON_BLK: Digimon = {
  ...
  name: 'Gabumon (Blk)',
  description:
    'A Gabumon that Digivolved into a virus type. It seems its fur was made from collecting Garurumon virus type data. While a bit of a hooligan, strip it of its pelt and it becomes bashful and cowardly. Its true face is a secret.',
  attribute: Attribute.Fire,
  stage: Stage.Rookie,
  type: DigimonType.Virus,
  memoryUsage: 5,
  ...
  skills: skillMappings.GABUMON_BLK,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 6,
...
export const GOBLIMON: Digimon = {
  ...
  name: 'Goblimon',
  description:
    "An impish Digimon that loves evil. With a cunning and cowardly personality, it prefers to attack in groups from the shade of trees or ambush from inside buildings. The moment things get dicey, however, they'll scatter to the winds as fast as their legs can take them. To that extent it has a bit more brains than other Rookie Digimon. Its special move Goblin Strike hurls fireballs at mach speed.",
  attribute: Attribute.Earth,
  stage: Stage.Rookie,
  type: DigimonType.Virus,
  memoryUsage: 4,
...
export const ZUBAMON: Digimon = {
  ...
  name: 'Zubamon',
  description:
    'One of the Legend-Arms that can change itself into a weapon. Legends say that such weapons would "save the world if held by an angel, or destroy it if held by a demon". Zubamon has the "Twentiest" data, and often shouts "I am the Twentiest!" without knowing what it means. It hates anything not fair or above board, and always seeks sharpness. Days of sharp gags and sharp battles make it happy. It charges head-first with its Twenty Dive move, but Zubamon\'s power manifests when it turns into its weapon form.',
  attribute: Attribute.Neutral,
  stage: Stage.Rookie,
  type: DigimonType.Vaccine,
  memoryUsage: 5,
...
export const SOLARMON: Digimon = {
  ...
  name: 'Solarmon',
  description:
    'A supposedly rare type of machine Digimon. Some researchers posit it as a mutation of Hagurumon, but no one knows for sure. The heat generated from its DigiCore makes its body hot enough to burn at the touch. Its special move Solar Flare launches a red-hot gear to scorch the enemy.',
  attribute: Attribute.Light,
  stage: Stage.Rookie,
  type: DigimonType.Vaccine,
  memoryUsage: 4,
...
export const CHUUMON: Digimon = {
  ...
  name: 'Chuumon',
  description:
    "A mouse-like Digimon that is always up to mischief with Sukamon. The two share a firm friendship (at least Chuumon thinks so). Sukamon happened to pass by when it was about to be captured by the network trap Carnivore, saving it by accident. It is fundamentally cowardly, but it doesn't lose when it comes to cunning, and runs away when things get dicey. Its special move Cheese Bomb hurls a cheese shaped explosive, sure to cause misfortune to any who mistake it for food.",
  attribute: Attribute.Earth,
  stage: Stage.Rookie,
  type: DigimonType.Virus,
  memoryUsage: 4,
...
export const TERRIERMON: Digimon = {
  ...
  skills: skillMappings.TERRIERMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 8,
...
export const TOYAGUMON: Digimon = {
  ...
  equipmentSlots: 1,
  supportSkill: supportSkills.ironcladDefense,
  skills: skillMappings.TOYAGUMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 8,
...
export const DRACMON: Digimon = {
  ...
  name: 'Dracmon',
  description:
    "The most mischievous Digimon of the Dark Area. It'll do anything for a prank, even face a bit of danger. It even risked its life once to draw graffiti on the faces of the 4 Sovereign Digimon (no word on if it succeeded). It is a vampiric Digimon, but lately it's forgotten about blood, focusing entirely on pranking the Royal Knights. Those that look at the Eye of Nightmares released from the evil eyes on its palms fall prey to Dracmon's control. Its Undead Fang technique better reflects its vampiric nature, biting foes with its fangs.",
  attribute: Attribute.Dark,
  stage: Stage.Rookie,
  type: DigimonType.Virus,
  memoryUsage: 5,
...
export const DRACOMON: Digimon = {
  ...
  name: 'Dracomon',
  description:
    'An ancient pure-blooded dragon Digimon said to be the progenitor of all Dramon-type Digimon. Its small build holds unimaginable power and agility, making it top class among Rookies. Dracomon has a savage personality, but can be docile towards opponents it approves of. It has wings, but they are not developed enough for flight. It also loves collecting shiny things, particularly gems and metals, and eats its favorites to absorb them. Its special move Baby Breath blows a high-temperature sigh at the opponent.',
  attribute: Attribute.Fire,
  stage: Stage.Rookie,
  type: DigimonType.Data,
  memoryUsage: 5,
...
export const HAGURUMON: Digimon = {
  ...
  name: 'Hagurumon',
  description:
    "A mutated machine Digimon with a body composed of countless turning gears. If even a single gear is removed, all of the other gears will stop turning and it will be unable to maintain its life force. Hagurumon can transmit a computer virus to its opponent and control it, an ability exploited by villainous Digimon. Hagurumon has no sense of self, and doesn't understand it's being used for evil. Its special move Cog Crusher buries an infected black gear in its opponent, driving them crazy.",
  attribute: Attribute.Electric,
  stage: Stage.Rookie,
  type: DigimonType.Virus,
  memoryUsage: 4,
  equipmentSlots: 1,
  supportSkill: supportSkills.metalEmpire,
  skills: skillMappings.HAGURUMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 7,
...
export const DEMIDEVIMON: Digimon = {
  ...
  equipmentSlots: 1,
  supportSkill: supportSkills.nightmareSoldiers,
  skills: skillMappings.DEMIDEVIMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 8,
...
export const FALCOMON: Digimon = {
  ...
  name: 'Falcomon',
  description:
    'A bird Digimon with wings to fly freely in the skies. Although it can fly, it specializes in riding massive kites and appearing from the skies like a ninja. Its special move is Ninja Blade, which throws a barrage of shuriken made from its stiff feathers.',
  attribute: Attribute.Wind,
  stage: Stage.Rookie,
  type: DigimonType.Vaccine,
  memoryUsage: 5,
...
export const FANBEEMON: Digimon = {
  ...
  skills: skillMappings.FANBEEMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 6,
...
export const VEEMON: Digimon = {
  ...
  name: 'Veemon',
  description:
    'A newly discovered species of Digimon. The last of the species that flourished in the genesis of the Digital World, it can use Digi-Eggs to undergo a pseudo-evolution called armor Digivolution. Veemon is a superior member of the combat species, possessing hidden power and tremendous ability when armor Digivolved. It has a naughty and playful side, but also holds a strong sense of justice. Its special move Veemon Headbutt defeats enemies with a powerful headbutt.',
  attribute: Attribute.Neutral,
  stage: Stage.Rookie,
  type: DigimonType.Free,
  memoryUsage: 5,
...
export const BETAMON: Digimon = {
  ...
  name: 'Betamon',
  description:
    'An amphibian Digimon that walks on four legs. Betamon is a gentle and docile creature, but sometimes it will get angry and unleash Electric Shock, an attack delivering over 1 million volts of electricity to the enemy.',
  attribute: Attribute.Water,
  stage: Stage.Rookie,
  type: DigimonType.Virus,
  memoryUsage: 4,
...
export const HAWKMON: Digimon = {
  ...
  name: 'Hawkmon',
  description:
    'A calm, collected and extremely courteous bird Digimon. Just like Veemon, it is a descendent of a unique species that prospered in ancient times, and can borrow the power of the Digi-Eggs for armored pseudo-evolution. Its special move Feather Slash uses the feather ornament on its head as a boomerang.',
  attribute: Attribute.Wind,
  stage: Stage.Rookie,
  type: DigimonType.Free,
  memoryUsage: 5,
...
export const MUSHROOMON: Digimon = {
  ...
  skills: skillMappings.MUSHROOMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 8,
...
export const MONODRAMON: Digimon = {
  ...
  skills: skillMappings.MONODRAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 8,
...
export const LALAMON: Digimon = {
  ...
  name: 'Lalamon',
  description:
    'A vegetation Digimon in the shape of a flower bud. Spinning the leaf on its head lets it float along. It lacks expression but still maintains its charm. The special move Seed Blast fires hard nuts with surprising accuracy.',
  attribute: Attribute.Plant,
  stage: Stage.Rookie,
  type: DigimonType.Data,
  memoryUsage: 4,
...
export const RENAMON: Digimon = {
  ...
  name: 'Renamon',
  description:
    "A beast humanoid Digimon shaped like a golden fox. Renamon's relationship to humans is clearly shown, and if raised properly, its in-training form can Digivolve into a Renamon of high intelligence. Calm and collected at all times, it trains so as not to lose that cool in any situation. Its tall, slender form stands out among Rookie Digimon, and it prefers the speed of its many techniques over power when it comes to fighting the enemy. Its special move Diamond Storm hurls razor sharp wood chips at the enemy.",
  attribute: Attribute.Plant,
  stage: Stage.Rookie,
  type: DigimonType.Data,
  memoryUsage: 5,
...
export const LOPMON: Digimon = {
  ...
  name: 'Lopmon',
  description:
    'An extremely precious twin Digimon Rookie. Terriermon has one horn on its head, but this Digimon has three. Its ecosystem is wrapped in mystery. Its composition is enough to deem it a beast-type Digimon, but nothing else is known about it. Terriermon may have a calm and chipper personality, but in contrast Lopmon is a crybaby with a lonely streak. Neither can be considered Digimon of the combat species, but they show unexpected power in battle. Special move is Blazing Ice, and shoots cold air bullets.',
  attribute: Attribute.Earth,
  stage: Stage.Rookie,
  type: DigimonType.Data,
  memoryUsage: 4,
...
export const ICEDEVIMON: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    'A dark angel Digimon with a heart as cold as ice. This is the form that Devimon with the cruelest hearts take after Digivolution. It deceives enemies with its silver tongue, and uses wings of ice to freeze them where they stand.',
  supportSkill: supportSkills.supremeFocus,
  skills: skillMappings.ICEDEVIMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 15,
...
export const ICEMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    'A Digimon whose body is composed of water. Its origins are currently being researched; perhaps it Digivolved from Gotsumon, or maybe it is some sort of mutation. Its special move Iceball Bomb throws ice-cold frozen bombs.',
  supportSkill: supportSkills.deepSavers,
  skills: skillMappings.ICEMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 15,
...
export const AGUNIMON: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    'A Digimon with the power of flame bearing the might of a legendary warrior. Its DigiCore is wrapped in a spiritual fire called a holy blaze, giving it power over flames. This guardian deity is the incarnation of internet firewalls. It has a militaristic side, using yoga breathing to keep its fiery disposition in check, and uses archaic speech. It wields martial arts in battle, focusing its spirit to gather flames in its body to raise its attack power. Its special move Pyro Punch shoots a blazing dragon from a flame-wrapped fist.',
  supportSkill: supportSkills.humanSpirit,
  skills: skillMappings.AGUNIMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 15,
...
export const ARCADIAMON_CHAMPION: Digimon = {
  ...
  supportSkill: supportSkills.utopia,
  skills: skillMappings.ARCADIAMON_CHAMPION,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 16,
...
export const ANKYLOMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    'An armored dragon Digimon covered completely in hardened skin. It is both hardened and covered in tough protuberances, giving its charge attack incredible destructive power. As an herbivore it lacks ferocity, but it still has a brave nature. Its special move Tail Hammer knocks the iron ball on the tip of its tail at the enemy. Any Digimon hit by this technique has its entire skeleton (wire frame) utterly obliterated.',
  supportSkill: supportSkills.ironcladDefense,
  skills: skillMappings.ANKYLOMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 15,
...
export const WIZARDMON: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    'A high-level titan wizard Digimon from other dimensional Digital World. It mastered flame and earth magic (high-level programming languages) in its native Digital World, Witchelny. It aims to be a grand sorcerer, and appeared in the Digital World to train. A bit impish, but its shy side prevents it from showing its face. Its special move Thunder Cloud summons thunderclouds to rain down an intense lightning storm.',
  supportSkill: supportSkills.adroitWisdom,
  skills: skillMappings.WIZARDMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 14,
...
export const GAOGAMON: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    'This beast Digimon has grown bigger than Gaomon in stature, and its glove-protected claws have fully grown. It walks on all fours, but its fearsome leg strength lets it stand and attack like a bear. Its special move Spiral Blow shoots a powerful, spiral shaped gust of air from its mouth.',
  supportSkill: supportSkills.feint,
  skills: skillMappings.GAOGAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 15,
...
export const KABUTERIMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    "An insectoid Digimon that's unique among newly-discovered Digimon. The details behind its Digivolution into an insect type are unclear, but it has both ant-like power and a beetle-like perfect defense. Its personality itself is insectile and it possesses no intellect, just an instinct to survive. It will relentlessly attack its antagonists, the virus type Digimon. Its metallic cranium boasts unrivaled defense. Its special move is called Electro Shocker.",
  supportSkill: supportSkills.numbingWaves,
  skills: skillMappings.KABUTERIMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 14,
...
export const GARGOMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    "A beast humanoid Digimon Digivolved from Terriermon and a special hunter Digimon. It's faster than it looks, attacking with pinpoint accuracy to bring down its foes. It can jump high in the air with its powerful legs and spread its ears to fly. Its cheerful personality gives way to an unstoppable fury when angered. It's picky about its favorite D-VI'S 503xx jeans. Its special move Dumdum Uppercut makes it close in on the enemy and hurl its Gatling arm up at it.",
  supportSkill: supportSkills.bullsEye,
  skills: skillMappings.GARGOMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 15,
...
export const GARURUMON_BLK: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    'A virus type Garurumon. The blades on its shoulders are powerful enough to dice everything they touch to pieces. It loves collecting bones and burying them in the ground, but it seems that the trickster Drimogemon sneaks off with them.',
  supportSkill: supportSkills.menace,
  skills: skillMappings.GARURUMON_BLK,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 15,
...
export const KURISARIMON: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    "A chrysalis-like Champion Digimon. The Rookie Keramon becomes a pupa and preserves its energy in order to Digivolve into a stronger form. As a result it can't move at all, but is protected by a shell, and attacks enemies with the tentacles sprouting from its back. Rumors say it can skip Champion form and Digivolve to Ultimate if the circumstance allows, but Digivolving to Kurisarimon lets it Digivolve into a strong Ultimate Digimon. Its Special move Data Crusher destroys an opponent's composition data with its tentacles.",
  supportSkill: supportSkills.destroyer,
  skills: skillMappings.KURISARIMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 16,
...
export const GREYMON_BLUE: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    "A virus type Greymon with bluish black body color. Its ferociousness has increased, to the point where it can be called a completely wild Greymon. Even so, it isn't a lone wolf, and is clever enough to engage in team tactics with its comrades.",
  supportSkill: supportSkills.dragonsWrath,
  skills: skillMappings.GREYMON_BLUE,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 16,
...
export const COREDRAMON_BLUE: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    "This blue Coredramon Digivolves from a Dracomon that absorbed a lot of a rare jewel called Blue Diamante mined from mountains at high altitudes. It can fly at high speeds using wings developed for survival on craggy mountains. Its special move Blue Flare Breath shoots sparkling blue, white-hot breath. The attack dismantles the texture data covering a Digimon's body, letting Coredramon attack their exposed DigiCore directly.",
  supportSkill: supportSkills.gekirin,
  skills: skillMappings.COREDRAMON_BLUE,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 14,
...
export const GOLDNUMEMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    'A golden subspecies of Numemon. A Numemon that has taken in data from Goldeen Mine. Its special move Golden Rush throws rapid-fire poop.',
  supportSkill: supportSkills.millionaire,
  skills: skillMappings.GOLDNUMEMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 18,
...
export const SUNFLOWMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    'A sunflower-shaped vegetation Digimon. Basking in sunlight gives it energy and increases its attack power. On sunny days it flaps the leaves on its back and flies around. Its special move Sunshine Beam is a beam of sunlight shot from its petals.',
  supportSkill: supportSkills.flowerGuard,
  skills: skillMappings.SUNFLOWMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 14,
...
export const SEADRAMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    'This aquatic Digimon has a long, serpentine body. It coils its body around attacking foes and squeezes them until they perish. It has pretty much no intellect, swimming around the net oceans by instinct. Its special move Ice Blast shoots absolute zero breath from its mouth, instantly freezing water and sending it at enemies.',
  supportSkill: supportSkills.mysteriousScale,
  skills: skillMappings.SEADRAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 14,
...
export const GEOGREYMON: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    'A special Digimon surmised to be a subspecies of Greymon. The shells on its head and body are completely weaponized, giving it a more aggressive form. Special move Mega Burst charges a Mega Flame to maximum inside its mouth and releases it with tremendous force.',
  supportSkill: supportSkills.fightOrFlight,
  skills: skillMappings.GEOGREYMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 15,
...
export const SUKAMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    'A nasty Digimon that looks like golden poop. Scraps of data thrown in computer recycle bins gathered and mutated to create this creature. It loves dark places, and as a collection of scrap data it is harassed by other Digimon, much like Numemon. Intelligence and attack power are nonexistent. Its partner Chuumon is a small, mouse-like Digimon that cannot fight, but its cunning is second-to-none, and instigates Sukamon to commit crimes.',
  supportSkill: supportSkills.toFightAnotherDay,
  skills: skillMappings.SUKAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 12,
...
export const STARMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    "A planet-type Digimon discovered in a planet analysis software at a space development center. This space warrior dons a star-shaped armor suit, and star-marked gloves and boots. Its tattered yellow scarf tells of Starmon's combat experience. Its eyes burn with fighting spirit and can convey this to opponents without a word. It can even use this ability effect to hypnotize its foes. This hot-blooded Digimon idolizes the brave Leomon. Special move Meteor Shower rains small meteors on the enemy.",
  supportSkill: supportSkills.justiceUnion,
  skills: skillMappings.STARMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 14,
...
export const STINGMON: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    'An extremely rare insectoid Digimon with a human form, possessing the hard exoskeleton and quick movements of its type. It excels in assassination, aiming for vitals with quick movement and precise judgment. It boasts attacks that silence the enemy in a single blow. It is composed and intelligent, possessing a calm personality. The special move Spiking Strike is a dreadful skill that skewers foes with the spikes on both arms.',
  supportSkill: supportSkills.natureSpirits,
  skills: skillMappings.STINGMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 14,
...
export const SOCERIMON: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    'A comrade of Wizardmon that came from the other-dimensional Digital World, Witchelny. It controls light and ice magic (high-level programming languages), and it can heal wounds with holy power through prayer. Its special move Crystal Cloud summons snow clouds from its snow crystal-laden staff to cause incredible snowstorms.',
  supportSkill: supportSkills.supremeFocus,
  skills: skillMappings.SOCERIMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 16,
...
export const TURUIEMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    'A martial artist Digimon discovered in the back regions of a Chinese mountain province. It wanders the world in pursuit of its arch enemies, viruses that do evil through email. It has the makings of an exceptional kenpo practitioner, but still lacks training. It uses the Togaken style it invented itself, and its finishing move Ninja Fist is a nimble stealth attack making use of its jumping power. Its special move Ninja Claw uses its rabbit-like agility and jumping power to unleash rapid blows with Tokaku Tessou claws.',
  supportSkill: supportSkills.animalColosseum,
  skills: skillMappings.TURUIEMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 14,
...
export const TOGEMON: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    "A vegetation Digimon shaped like a massive cactus. Its body stores nutrition data, letting it survive for a while even in stark desert areas. The look on its face makes it impossible to tell what it's thinking, and it spends most of the day just zoned out. If Togemon is ever angered its expression changes and it goes on a rampage. Its special move Needle Spray hardens the thorns on its arms and rains down punches.",
  supportSkill: supportSkills.poisonThorns,
  skills: skillMappings.TOGEMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 16,
...
export const NUMEMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    "A mollusk Digimon with a body like a slug. It loves dark and damp environments, and has neither attack power nor intelligence. If you mess up its rearing it'll turn into Numemon, but it seems there's a hidden secret... To protect itself from external threats, it throws its poop in the grossest attack possible.",
  supportSkill: supportSkills.scavenge,
  skills: skillMappings.NUMEMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 12,
...
export const BAOHUCKMON: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    'The form of Hackmon after heaping on rigorous training, honing its combat sense into something exceptional, with a physique to match. It aims for the top and continues training, accumulating combat experience against powerful foes and becoming a more skillful combatant with every fight. Its aspiration to become a Royal Knight has grown as well; not because it was told by someone that it should, but by its own conviction. Its special move Fif Cross strengthens its whole body and rends with its claws.',
  supportSkill: supportSkills.battleSense,
  skills: skillMappings.BAOHUCKMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 16,
...
export const HUDIEMON: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    'A humanoid insectoid Digimon with butterfly wings. It is cautious at first, but once it gets to know someone it has a cheerful, innocent countenance. It likes to sing while dancing gracefully in well-lit places, and its voice is considered an eternal treasure. Its special move Flying Kick is a high-flying dropkick, and its Infinity Dream move blows scales from its flapping wings. Using Infinity Dream on an enemy can poison or paralyze it, but it is mainly used to ease the pain of injured allies and raise their spirits.',
  supportSkill: supportSkills.infinityDream,
  skills: skillMappings.HUDIEMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 15,
...
export const PLATINUMSUKAMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    "A poop-shaped Digimon sparkling like platinum, Sukamon took ore data from rare metals that look gorgeous, but its abilities are the same as Sukamon. It doesn't power up at all. Its special move Rare Metal Poop throws glittering metallic poop at the enemy.",
  supportSkill: supportSkills.platinumService,
  skills: skillMappings.PLATINUMSUKAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 20,
...
export const BLACKGATOMON: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    "An impressive virus type of Gatomon with a pitch black fur coat, this pure evil child wanders the eerie darkness. The mutation of Gatomon that makes BlackGatomon is quite rare, and its population is pretty low. Both malicious and prideful, this messed-up Digimon loves bullying the weak. It's basically a dark type Digimon that Digivolved into a dark angel version of Gatomon. Its special move is Lightning Paw (the same as Gatomon).",
  supportSkill: supportSkills.nightmareSoldiers,
  skills: skillMappings.BLACKGATOMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 16,
...
export const PECKMON: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    'A bird Digimon with powerful legs that run faster than it can fly. Its special move Kunai Wing shoots steel feathers from its wings.',
  supportSkill: supportSkills.windGuardians,
  skills: skillMappings.PECKMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 14,
...
export const MONOCHROMON: Digimon = {
  ...
  supportSkill: supportSkills.ironcladDefense,
  skills: skillMappings.MONOCHROMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 14,
...
export const REPPAMON: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    'A mythological Digimon with a blade on its tail. The blade itself has its own will, letting it make surprise attacks from behind. But that will is not mutual, and it is observed arguing with itself in the middle of combat. It prefers fighting in the woods, using its claws and tail to easily run amongst the trees. One needs to take caution when fighting Reppamon in the woods. Its special move Razor Wind charges in a forward somersault.',
  supportSkill: supportSkills.mysticProtection,
  skills: skillMappings.REPPAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 16,
...
export const ARCADIAMON_ULTIMATE: Digimon = {
  ...
  supportSkill: supportSkills.utopia,
  skills: skillMappings.ARCADIAMON_ULTIMATE,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 30,
...
export const METEORMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'Its appearance is due to the meteorite data inside the mineral data that Gotsumon had. It is made of a hard material only found up in space and therefore has great defensive strength. Its special move is called Galactic Flare, where it creates a mysterious energy wave of the cosmos.',
  supportSkill: supportSkills.animalColosseum,
  skills: skillMappings.METEORMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 26,
...
export const INFERMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'An Ultimate Digimon that looks like a spider with very long legs that it can also retract into a cocoon. When it is a cocoon it avoids any attacks, increasing its defense, but in this state it can only move forward without turning. Can infiltrate any network no matter how tough the security. If the Infermon is unleashed, it may end in global chaos. Its special move is a Spider Shooter that emits awesome destructive energy from a gun in its mouth.',
  supportSkill: supportSkills.destroyer,
  skills: skillMappings.INFERMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 30,
...
export const WINGDRAMON: Digimon = {
  ...
  skills: skillMappings.WINGDRAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 30,
...
export const AEROVEEDRAMON: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    'A further Digivolved Veedramon called AeroVeedramon because it can fly through the air. Among the rare Veedramon, it is the only one with proven fighting strength and it has even gone down into legend for it. Not only has it gained wings in its Digivolution, it also has characteristics for battle, making it more offensive and defensive. Its special move is a Dragon Impulse which is a wave in the shape of a dragon.',
  supportSkill: supportSkills.swiftness,
  skills: skillMappings.AEROVEEDRAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 30,
...
export const KENDOGARURUMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    "A Digimon with the power of light bearing the might of a legendary warrior. Perhaps due to the fiber optic network it was discovered in, it can move at ultrahigh speed and dodge bullets. It will close in and use sharp claws and fangs to tear apart foes it deems evil. It loathes evil, and its righteous heart befits its idol Garm from Norse mythology. It won't follow those with any evil in their heart, but never betrays those it pledges loyalty to. Its special move Speed Star use the wing blades on its back to rip up enemies.",
  supportSkill: supportSkills.beastSpirit,
  skills: skillMappings.KENDOGARURUMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 30,
...
export const GIGADRAMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A dark dragon Digimon developed at the same time as Megadramon. This is a combat dragon fully armored which exists as a brutal computer virus. Its special move is Genocidal Gears which unleashes infinite organic missiles.',
  supportSkill: supportSkills.ironcladDefense,
  skills: skillMappings.GIGADRAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 26,
...
export const CANNONBEEMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A super-large Digimon that protects the mysterious aerial Royal Base. The aerial base faces threats from all sides so it can unleash a huge barrage from its giant weapon container covering a large area. Against armored enemies, it can use its Nitro Stinger special move to destroy foes with a high-caliber laser.',
  supportSkill: supportSkills.royalCommando,
  skills: skillMappings.CANNONBEEMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 28,
...
export const GROUNDRAMON: Digimon = {
  ...
  skills: skillMappings.GROUNDRAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 30,
...
export const CRESCEMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A titan wizard Digimon that uses its flexible body to strike down foes with limber movements. Specializing in elegant combat, its power is said to double under the light of the moon. Its special move Lunatic Dance entrances foes with graceful steps, after which it exploits the opening to slash them with the Nova Luna blades in its hands.',
  supportSkill: supportSkills.moonKissedBlade,
  skills: skillMappings.CRESCEMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 30,
...
export const SUPERSTARMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    "A mutant Digimon that is the ultimate form of the space warrior, Starmon. It has dressed up in flashy clothes of its own choice and made its debut as a true star. Because of its super stardom, it wears sunglasses to hide its identity, but they don't really work... Its special move is Haley Storm where numerous meteorites fall onto the heads of its enemies.",
  supportSkill: supportSkills.justiceUnion,
  skills: skillMappings.SUPERSTARMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 28,
...
export const TAOMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    "A Taoist Digimon that uses all the skills of faith to defeat opponents. It is particularly talented at curses and charms. It also keeps a number of dark implements hidden on its body. This Digimon doesn't say much and resides in the dark. It can also change charms into djinnis. Its special move is called Talisman of Light where it throws the enemy up into the air with a huge brush while chanting a curse. Victims of this move will be destroyed in a huge explosion.",
  supportSkill: supportSkills.adroitWisdom,
  skills: skillMappings.TAOMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 30,
...
export const TRICERAMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A bipedal horned dragon Digimon, with the form of a triceratops and power competing with the strongest of herbivorous dinosaur types. The toughness of its skin is top class among organic type Digimon, and its two ultra-hard horns are more solid than Monochromon. It is gentle by nature, but its charging attack belies its usual sluggish movements, full of power capable of destroying even the sturdy bodies of mineral Digimon. Its special move Tri-Horn Attack charges into enemies with the horns on its forehead and snout.',
  supportSkill: supportSkills.ironcladDefense,
  skills: skillMappings.TRICERAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 28,
...
export const DORUGREYMON: Digimon = {
  ...
  supportSkill: supportSkills.haymaker,
  skills: skillMappings.DORUGREYMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 30,
...
export const PAILDRAMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A dragon humanoid Digimon DNA Digivolved from an ExVeemon and a Stingmon. It retains many elements of dragon types with the power of a dragon and the iron-wall defense of an insect type. Its real advantages are agility and quick moves against opponents. It is very loyal and will unquestioningly lay down its life. Its special move is an energy wave called Death Parade Blaster fired from two biological cannons on its waist.',
  supportSkill: supportSkills.backwaterCamp,
  skills: skillMappings.PAILDRAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 30,
...
export const PANJYAMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A beast humanoid Digimon with a strong sense of justice. They are digivolved from Leomon who have spent days training to uphold what is right and have gained the power of the cold by being in the polar areas of the Digital World. Their will and bodies have been strengthened by the freezing cold and no attack can crush them. Their special move is a freezing punch called Fist of Ice.',
  supportSkill: supportSkills.animalColosseum,
  skills: skillMappings.PANJYAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 28,
...
export const PUMPKINMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    "A stuffed toy Digimon with a pumpkin head. There is an urban legend that says Pumpkinmon is a virus that mutated on Halloween. It is not a malicious virus, so it doesn't do harm, but its appearance hides a powerful attack. Its cute face doesn't betray emotion--a characteristic of puppet-type Digimon. For its special move it creates a pumpkin from nowhere to crush the enemy. This move is known as Trick or Treat.",
  supportSkill: supportSkills.strangeDance,
  skills: skillMappings.PUMPKINMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 26,
...
export const HIPPOGRYPHONMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A mythical beast Digimon with the appearance of a chimera. It is said to Digivolve into Gryphonmon, but the full details of this process is unknown. It is less intelligent than Gryphonmon, with a more feral and ferocious nature. Its special move Heat Wave shoots extremely hot wind from its mouth.',
  supportSkill: supportSkills.windGuardians,
  skills: skillMappings.HIPPOGRYPHONMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 26,
...
export const BLACKKINGNUMEMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A mollusk Digimon which has established its position as king of the dark trash data world. Its special move is Dark Pupil.',
  supportSkill: supportSkills.scavenge,
  skills: skillMappings.BLACKKINGNUMEMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 32,
...
export const BLUEMERAMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A fire Digimon which burns with an even greater intensity than a Champion Meramon. Its special move is Ice Phantom, which burns the enemy with freezing air.',
  supportSkill: supportSkills.dragonsRoar,
  skills: skillMappings.BLUEMERAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 28,
...
export const MAGNAANGEMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    "A high angel Digimon with eight sparkling silver wings. MagnaAngemon's job in the Digital World is law enforcement, and it supervises most of the other high angel Digimon. It speaks for the light that protects the order of the Digital World, and thus normally takes the appearance of a priest, but when the Digital World is shrouded in dark, it changes into battle mode to fight evil with unique weapons. Its special move is called Heaven's Gate. It sends enemies through a door of no return.",
  supportSkill: supportSkills.justiceGenome,
  skills: skillMappings.MAGNAANGEMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 30,
...
export const MACHGAOGAMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'An android Digimon which has a robot engine with impressive propulsion force. Its flight duration is short, but its specializes in massive hit-and-run instantaneous attacks. Its special move is Winning Knuckle which is a single strike with amazing power.',
  supportSkill: supportSkills.feint,
  skills: skillMappings.MACHGAOGAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 26,
...
export const MEGASEADRAMON: Digimon = {
  ...
  supportSkill: supportSkills.mysteriousScale,
  skills: skillMappings.MEGASEADRAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 30,
...
export const MEGADRAMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    "A dark dragon that can boast to be the most powerful and evil among the Ultimate dragon cyborg Digimon. It has been artificially remodeled by someone and programmed to destroy everything. It's very existence can be considered a computer virus by the way it easily infiltrates secure computer networks, destroying or rebuilding the host computer with no obstacles. Special move is multiple organic missiles fired from its arms called Genocide Attack.",
  supportSkill: supportSkills.bullsEye,
  skills: skillMappings.MEGADRAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 26,
...
export const METALTYRANNOMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'An android Digimon that was created to hold great power within its body. MetalTyrannomon is a continuation of the aerial Megadramon, and has been remodeled as a ground interception model. Its enhanced body has impressive attack power, repelling any attack and chewing through the strongest armor with its powerful jaw. Its special move is a Nuclear Laser which it fires from its left arm.',
  supportSkill: supportSkills.menace,
  skills: skillMappings.METALTYRANNOMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 28,
...
export const CROWMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A mutated mysterious bird Digimon with three legs. To look at, its dark body seems evil, but this is the Digimon of legend who will lead the chosen ones to the El Dorado that lies in the East of the Digital World. Its special move is Savage Emperor and shoots energy forward. Digimon who fall victim to this skill will have their digital cells broken down into binary zeros and ones.',
  supportSkill: supportSkills.windGuardians,
  skills: skillMappings.CROWMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 30,
...
export const RIZEGREYMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    "An android Digimon which has over half of its body mechanized. Regardless of its huge size, it can soar in order to punish its enemies. The attack power of the giant revolver on its left arm can annihilate the foe in one shot. It's not usually possible to fire due to recoil and power. The only thing that can withstand such strength is Chrome Digizoid. Its special move, Trident Revolver, is high velocity shots (three bursts) at the durability limit of Chrome Digizoid.",
  supportSkill: supportSkills.fightOrFlight,
  skills: skillMappings.RIZEGREYMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 30,
...
export const LUCEMON_FM: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    'An evil king Digimon both holy and evil, and the strongest of the Seven Deadly Digimon. In an ancient rebellion, it was sealed away in a Dark Area with many other evil king Digimon. Its power is greater than that of an Ultimate and is almost godlike. While it cherishes all living things, it also has another side that wants to annihilate this world and build a new one from the rubble. Its special move is sealing enemies away in a bubble of holy darkness called Dead or Alive.',
  supportSkill: supportSkills.pride,
  skills: skillMappings.LUCEMON_FM,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 55,
...
export const LADYDEVIMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A female fallen angel Digimon with noble dignity. It has unrivaled strength and pure dark-side power, and almost none have grown up on a private server. Its special move called Darkness Wave unleashes a myriad of dark and bat-like creatures that burn its enemies.',
  supportSkill: supportSkills.nightmareSoldiers,
  skills: skillMappings.LADYDEVIMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 30,
...
export const WEREGARURUMON_BLK: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A Digimon evolved from a virus-type Garurumon. Because this Digimon has two feet, it is slower, but it makes up for this by using its arms to deliver powerful attacks.',
  supportSkill: supportSkills.menace,
  skills: skillMappings.WEREGARURUMON_BLK,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 28,
...
export const ARCADIAMON_MEGA: Digimon = {
  ...
  supportSkill: supportSkills.utopia,
  skills: skillMappings.ARCADIAMON_MEGA,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 60,
...
export const ULFORCEVEEDRAMON: Digimon = {
  ...
  supportSkill: supportSkills.swiftness,
  skills: skillMappings.ULFORCEVEEDRAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 60,
...
export const VARODURUMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    "An elusive holy bird Digimon living 40,000 m up in the stratosphere. It has six massive wings, the largest of which give it a 3 m wingspan. Legends call it the guardian of the skies, and claim it to be an ancient Digimon that has existed since the Digital World began. Varodurumon's feathers always emit the holy light of Purge Shine, shrouding it in a barrier that nullifies all attacks composed of ill will. Its special move Aurora Undulation amplifies the purifying light of Purge Shine to its maximum before firing it.",
  supportSkill: supportSkills.purgeShine,
  skills: skillMappings.VARODURUMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 55,
...
export const VENOMMYOTISMON: Digimon = {
  ...
  supportSkill: supportSkills.nightmareSoldiers,
  skills: skillMappings.VENOMMYOTISMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 55,
...
export const OPHANIMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    "A super angel Digimon which is the final form of the female angel Digimon. It is one of the celestial Digimon that protect the Digital World's kernel (the domain of God) along with Seraphimon and Kerpymon. It is the mother figure of the Digital World and shows the loving and benevolent side of God, while Seraphimon is the executor of God's law, and Kerpymon is the guardian of God and wisdom. Its special move is Eden's Javelin.",
  supportSkill: supportSkills.holyRing,
  skills: skillMappings.OPHANIMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 55,
...
export const GAIOMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    "A dragon humanoid Digimon that belongs to the Greymon type which is highly capable as a combat species, with its strength increasing with battle victories. It was discovered in a discarded computer. Many aspects of its strength cannot be measured, but it has proven battle experience. Its swords called Kikurin have a unique shape that was formed over the course of its battles, and creates strange tracks of light that slice those who touch them to pieces. Special move Will-o' Wisp Slash draws these tracks together.",
  supportSkill: supportSkills.backwaterCamp,
  skills: skillMappings.GAIOMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 50,
...
export const GRYPHONMON: Digimon = {
  ...
  supportSkill: supportSkills.windGuardians,
  skills: skillMappings.GRYPHONMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 50,
...
export const CRANIAMON: Digimon = {
  ...
  supportSkill: supportSkills.ironcladFortification,
  skills: skillMappings.CRANIAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 60,
...
export const KERPYMON_BLK: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    "A Seraph angel Digimon with the appearance of a beast. It is one of the great angel Digimon and has the highest position, along with angel of valor Seraphimon. It guards the Digital World's kernel. Angel Digimon are fanatically good, however, and this can quickly lead them on the path of pure evil. It wields an intense electric staff, and its blow is considered to be divine punishment. Its special move is the Lightning Spear.",
  supportSkill: supportSkills.evilHeart,
  skills: skillMappings.KERPYMON_BLK,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 55,
...
export const KERPYMON_GOOD: Digimon = {
  ...
  supportSkill: supportSkills.meditation,
  skills: skillMappings.KERPYMON_GOOD,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 55,
...
export const SHINEGREYMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    'A shining dragon Digimon that attacks using the energy of the scorching sun. It has an ability where it can summon a GeoGrey Sword from the ground using the pure, condensed power of Gaia.',
  supportSkill: supportSkills.fightOrFlight,
  skills: skillMappings.SHINEGREYMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 55,
...
export const SHINEGREYMON_BM: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    'ShineGreymon undergoes Burst Digivolution, temporarily evoking its full potential and giving it a special form wrapped in solar class high-energy flames. Its special move Final Shining Burst induces a massive explosion infused with its entire being.',
  supportSkill: supportSkills.shiningBurst,
  skills: skillMappings.SHINEGREYMON_BM,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 60,
...
export const SLAYERDRAMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    'A dragon humanoid Digimon clad in Chrome Digizoid scale armor. Its form is one only dragon humanoid Digimon can achieve after completing the training known as the Trial of the Four Great Dragons. Slayerdramon carries the telescoping long sword Fragarach, and has mastered its ultimate swordsmanship, the Dragon Slashing Sword (Ryuzanken). This sword style has three different forms; the first of which, Divine Dragon Slash, spins its body to accelerate its sword, cleaving an enemy in half from the head down.',
  supportSkill: supportSkills.tenryu,
  skills: skillMappings.SLAYERDRAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 55,
...
export const SERAPHIMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    'A Seraph angel Digimon that is dressed in holy armor that shines silver and has ten golden wings. It is the highest of all the angel Digimon and rules over them. Its true face and identity are completely hidden behind a mask, and it is the closest thing to the physical existence of God. It is said that it will purify everything when it descends for the final battle with evil. It is also said that evil king Digimon Creepymon is a fallen Seraphimon. Special move Strike of the Seven Stars fires seven light spheres.',
  supportSkill: supportSkills.justiceGenome,
  skills: skillMappings.SERAPHIMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 55,
...
export const MEGAGARGOMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A huge machine Digimon with a body made of a mass of weapons. Its high-temperature arsenal rivals that of the low-temperature MetalGarurumon. All of its lasers, missiles, bazookas, Vulcan cannons, and flamethrowers are hidden. It uses all of its energy as power so it is very slow although capable of amazing destruction. It can handle several enemies from any direction without taking a step. Special move Burst Shot fires a volley of firearms.',
  supportSkill: supportSkills.bullsEye,
  skills: skillMappings.MEGAGARGOMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 50,
...
export const DIANAMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A deity Digimon and member of the Olympos XII who presides over water and ice, and can fight in absolute zero temperatures. Just like there are two sides to the moon (light and dark), there are two sides to its personality. Special move Good Night Moon showers the enemy in moonlight from the Good Night Sisters on both of its feet.',
  supportSkill: supportSkills.moonKissedBlade,
  skills: skillMappings.DIANAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 55,
...
export const LEOPARDMON_LM: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    "It has a special move in leopard mode called Vulcan Crusher where it summons a tower of rock from the ground to toss enemies into the air. Also, the Leopardmon's round tail-tip can generate a ball of energy that becomes a weapon called Eroberung, which tactically surrounds the enemy.",
  supportSkill: supportSkills.leopardMode,
  skills: skillMappings.LEOPARDMON_LM,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    modeChange: true,
...
export const PILEVOLCAMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    'One of the several supposed Digivolutions for Volcanomon. It possesses dreadful power and destructive force, and is an expert in all combat sports, starting with pro wrestling. Its Digivolution has polished its massive body even further into a smart form suitable for melee combat. Its special moves are Volcanic Driver, which uses the volcanic eruption from its shoulders to slam enemies into the ground, and Diamond Fist, the ultimate fist that blows through even Chrome Digizoid.',
  supportSkill: supportSkills.unwaveringDefense,
  skills: skillMappings.PILEVOLCAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 50,
...
export const BARBAMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    'An evil king Digimon with the appearance of an old man with a long beard, and a member of the Seven Deadly Digimon. It resides at the center of the Dark Area which is a den of demons, and uses dark angel Digimon for true evil. It is obsessed with all treasure that exists on the network and will murder any Digimon to get it. This most scheming of the dark angel Digimon can even manipulate the Ultimate Ghoulmon. Special move Pandemonium Lost unleashes a dark angel.',
  supportSkill: supportSkills.greed,
  skills: skillMappings.BARBAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 60,
...
export const PIEDMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'Strange and mysterious titan wizard Digimon. There are many unknowns about titan wizard Digimon, and as demon and undead types are from another world, their true identities are not understood. Its reason for being here is unclear and there is no way of resolving the problem, but its strength is undisputed, and if you are unlucky to come against Piedmon, your fate is sealed. Inescapable special move Trump Sword teleports the four swords in its magic box to pierce its enemy.',
  supportSkill: supportSkills.trickster,
  skills: skillMappings.PIEDMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 50,
...
export const PLESIOMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A fantastical Digimon discovered on the computer of an unidentified British biological laboratory. Already infamous among researchers, it is rarely seen and it usually appears when there is plenty of mist so it cannot be identified easily. When seen it has a refined, glistening appearance. Special move Sorrow Blue is a shrill, crystal-clear voice that makes the hearer lose the will to fight.',
  supportSkill: supportSkills.deepSeaSlumber,
  skills: skillMappings.PLESIOMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 50,
...
export const BEELZEMON: Digimon = {
  ...
  supportSkill: supportSkills.gluttony,
  skills: skillMappings.BEELZEMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 60,
...
export const BELPHEMON_SM: Digimon = {
  ...
  equipmentSlots: 1,
  description:
    "A demon lord Digimon that is said to be sealed in the deepest parts of the Dark Area. Because of its immense power, its data has been put into sleep mode by the Digital World's system. Because it is in a deep sleep, it cannot attack directly, but it can inflict damage with its snores, which makes it difficult to attack. Special move Eternal Nightmare promises eternal slumber for its victims.",
  supportSkill: supportSkills.sloth,
  skills: skillMappings.BELPHEMON_SM,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 60,
...
export const HOUOUMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'This holy Digimon with four shining gold wings is the leader of all bird Digimon and it is said to rule over all the divine Digimon as well. Magnadramon is the ultimate form of beast Digimon, and Hououmon is the ultimate form of bird Digimon. Two holy rings are evidence of its divinity and proof that its strength is unfathomable. Special move Star-Light Explosion is a flap of its four golden wings that showers golden grains to purify its victim.',
  supportSkill: supportSkills.phoenixFeathers,
  skills: skillMappings.HOUOUMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 50,
...
export const BOLTMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A beta-type android Digimon created at the same time as Andromon. Unlike Andromon, which was made of machines, Boltmon was made of flesh and can feel emotion. Although this Digimon has great strength, it can easily lose control and fall into darkness. This tragic Digimon denies its own existence and walks in the dark. It easily wields a large battle ax as part of its special move Tomahawk Stinger.',
  supportSkill: supportSkills.immobility,
  skills: skillMappings.BOLTMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 50,
...
export const MAGNAGARURUMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A transcendent Digimon with power over light, said to even surpass the might of the Ten Warriors. Specializes in lightspeed movement, and is able to fly at subluminal speeds with its flight unit equipped. The laser sights on its chest rotate in-flight, locking on to air and ground targets from high in the sky for a general offensive. Escape from MagnaGarurumon is practically impossible. Its special move Machinegun Destroyer unleashes its arsenal onto locked targets, then violently crashes into the main target at high speed.',
  supportSkill: supportSkills.darkLgtThunderCannon,
  skills: skillMappings.MAGNAGARURUMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 50,
...
export const MAGNAGARURUMON_SV: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A transcendent Digimon with power over light, said to even surpass the might of the Ten Warriors. Its special move Starlight Velocity accelerates it from subluminal to superluminal speeds erasing anything that comes in contact with its light beam.',
  supportSkill: supportSkills.darkLgtThunderCannon,
  skills: skillMappings.MAGNAGARURUMON_SV,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    modeChange: true,
...
export const MARINEANGEMON: Digimon = {
  ...
  supportSkill: supportSkills.oceanLove,
  skills: skillMappings.MARINEANGEMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 50,
...
export const MINERVAMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'This deity Digimon with the appearance of a girl belongs to the Olympos XII. Although extremely short, it can wield a sword as large as its body with ease. It has a childlike innocence and can be emotionally unstable, and even throws uncontrollable tantrums. Special move Strike Roll is a forward slash with its great sword Olympia.',
  supportSkill: supportSkills.primalTrooper,
  skills: skillMappings.MINERVAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 55,
...
export const MIRAGEGAOGAMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A beast knight Digimon that wears full-body armor of Chrome Digizoid. Because it can move extremely fast, the enemy thinks that its appearance on the battlefield is only an illusion. Its special move is the Full Moon Blaster which is a single blow using the collected energy from its whole body, unleashed from an opening in its chest.',
  supportSkill: supportSkills.feint,
  skills: skillMappings.MIRAGEGAOGAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 55,
...
export const MIRAGEGAOGAMON_BM: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'MirageGaogamon undergoes Burst Digivolution, temporarily evoking its full potential and giving it a special form covered in planet class high-energy weapons and aura. Its special move Full Moon Meteor Impact strikes the enemy with a ball of light containing the energy of a planet.',
  supportSkill: supportSkills.mirageBurst,
  skills: skillMappings.MIRAGEGAOGAMON_BM,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 60,
...
export const METALETEMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    "This King of Digimon was once seen as the strongest of all Digimon, and would seek out the mightiest opponents to collect precious combat data. The constant battling seriously injured it, however, it then studied its own weaknesses with the data it had collected and has now been entirely reborn as an ultimate fighting machine. Its surface is coated in the Chrome Digizoid used by metal types, and its basic combat ability has reached its maximum. This strong and dirty wrestler's Banana Slip trips the enemy.",
  supportSkill: supportSkills.muscleMonkeySuit,
  skills: skillMappings.METALETEMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 45,
...
export const METALGARURUMON_BLK: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'A virus MetalGarurumon equipped with a cold air system on its body. Once it targets its prey with the laser sight on its nose it will maintain a lock regardless of friend or foe, and will unleash a terrifying missile attack. Special move Metal Wolf Claw freezes the air in an instant.',
  supportSkill: supportSkills.menace,
  skills: skillMappings.METALGARURUMON_BLK,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 55,
...
export const METALSEADRAMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'This final form of a Seadramon is entirely covered in Chrome Digizoit, the strongest metal known, which can reflect any attack. It has the fastest speed of any water-based Digimon, and is excellent at underwater interception in addition to land and air interception. Special move River of Power is an energy cannon that it fires from the tip of its nose.',
  supportSkill: supportSkills.mysteriousScale,
  skills: skillMappings.METALSEADRAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 50,
...
export const LILITHMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    "One of the Seven Deadly Digimon that takes the appearance of a woman. It is thought that she was originally the same type of Digimon as Ophanimon before she fell from Heaven to become known as the Goddess of Darkness. She confuses its enemy with her beauty, and those who fall to her temptation are rewarded in ruthless fashion. The Mystic Claw of her right hand corrodes anything it touches, while the special move Endless Nightmare rots the enemy's body, eventually deleting the victim's data.",
  supportSkill: supportSkills.lust,
  skills: skillMappings.LILITHMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 60,
...
export const RAVEMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    "An android Digimon that possesses wings made of Chrome Digizoid. At the creation of the Digital World, it served deity Digimon as the Silver Crow, but it was struck by God's anger and one of its wings was dyed black. It conceals itself with its dark wing and slashes at the enemy with its white wing. Appearing out of nowhere, it takes the enemy out with a single swift attack. Special move Celestial Blade is a blade of dark lightning from the Raven King.",
  supportSkill: supportSkills.windGuardians,
  skills: skillMappings.RAVEMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 55,
...
export const RAVEMON_BM: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    'Ravemon undergoes Burst Digivolution, temporarily evoking its full potential and giving it a special form wreathed in atmospheric energy in the form of an aura. Its special move Mourning Dance is a dreadful dance brought about by rage.',
  supportSkill: supportSkills.crimsonFormation,
  skills: skillMappings.RAVEMON_BM,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 60,
...
export const ROSEMON_BM: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'Rosemon undergoes Burst Digivolution, temporarily evoking its full potential and giving it a special form cloaked in an aura of love and beauty. Its special move Aguichant Lèvres is a laser released as a kiss blown from its lips.',
  supportSkill: supportSkills.tifaret,
  skills: skillMappings.ROSEMON_BM,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 60,
...
export const LOTOSMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    "A pixie Digimon that looks like a lotus flower. It has a calm, lady-like grace and it can make people forget the suffering of this brief life, giving them happy dreams. However, it will use its hammer on those who refuse its generosity. Special move is a seven-colored aura that it releases from the multi-colored staff in its right-hand. This move is called Seven's Fantasia and it renders the enemy unwilling to fight.",
  supportSkill: supportSkills.flowerGuard,
  skills: skillMappings.LOTOSMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 55,
...
export const ARCADIAMON_ULTRA: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    'The form taken when Arcadiamon Mega evolved even further when it absorbed energy generated from battles. Capable of rocking the ecosystem of the Digital World, its sheer power makes it known as a being exceeding Mega. Its special move Dystopia Lances absorbs data from Digimon and attack energy with just a touch of its countless feelers, and God Matrix is an unblockable attack that instantly dismantles anything and everything into ones and zeroes with invisible waves.',
  supportSkill: supportSkills.utopia,
  skills: skillMappings.ARCADIAMON_ULTRA,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 70,
...
export const IMPERIALDRAMON_PM: Digimon = {
  ...
  skills: skillMappings.IMPERIALDRAMON_PM,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 70,
...
export const EXAMON: Digimon = {
  ...
  digivolutionRequirements: {
    ...
    digimon: [SLAYERDRAMON, BREAKDRAMON],
  },
};
...
export const OMNIMON: Digimon = {
  ...
  digivolutionRequirements: {
    ...
    digimon: [WARGREYMON, METALGARURUMON],
  },
};
...
export const OMNIMON_ZWART: Digimon = {
  ...
  digivolutionRequirements: {
    ...
    digimon: [BLACKWARGREYMON, METALGARURUMON_BLK],
  },
};
...
export const CHAOSMON: Digimon = {
  ...
  digivolutionRequirements: {
    ...
    digimon: [DARKDRAMON, BANCHOLEOMON],
  },
};
...
export const CHAOSMON_VA: Digimon = {
  ...
  digivolutionRequirements: {
    ...
    digimon: [VARODURUMON, BANCHOLEOMON],
  },
};
...
export const SUSANOMON: Digimon = {
  ...
  digivolutionRequirements: {
    ...
    digimon: [KAISERGREYMON, MAGNAGARURUMON],
  },
};
...
export const BELPHEMON_RM: Digimon = {
  ...
  skills: skillMappings.BELPHEMON_RM,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    modeChange: true,
...
export const FLAMEDRAMON: Digimon = {
  ...
  equipmentSlots: 3,
  description:
    'An armor dragon humanoid Digimon Digivolved with the power of the Digi-Egg of Courage, which carries flame properties and increases combat strength like a raging fire, enabling powerful attacks on enemy Digimon. Its signature move is Flaming Fist, which delivers a fiery punch to the enemy.',
  supportSkill: supportSkills.fightOrFlight,
  skills: skillMappings.FLAMEDRAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 14,
...
export const MAGNAMON: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    'An armor holy knight Digimon that has Digivolved through the Digi-Egg of Miracles, giving it a metal attribute through the super metal Chrome Digizoid. Magnamon, which is a member of the Royal Knights, has immense defense capabilities and also has attack on a level with Ultimate forms. By gaining the power of the Digi-Egg of Miracles, it can overcome anything. Special moves are firing a plasma cannon called Plasma Shot, and Shining Gold Solar Storm that clears the enemy in a golden flash.',
  supportSkill: supportSkills.miracle,
  skills: skillMappings.MAGNAMON,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 60,
...
export const SISTERMON_C_AWAKE: Digimon = {
  ...
  equipmentSlots: 2,
  description:
    'Another form of Sistermon Noir. It wears a wimple on its head and a Holy Stigma appears on its chest, awakening its power. The feral power drawn out with its awakening raises its quick wits and movement, and it kills the enemy with a stooped-over stance.',
  supportSkill: supportSkills.feralPower,
  skills: skillMappings.SISTERMON_C_AWAKE,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    level: 60,
...
export const ALPHAMON_NX: Digimon = {
  ...
  skills: skillMappings.ALPHAMON_NX,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    nxDlc: true,
...
export const CRUSADERMON_NX: Digimon = {
  ...
  skills: skillMappings.CRUSADERMON_NX,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    nxDlc: true,
...
export const LEOPARDMON_NX: Digimon = {
  ...
  skills: skillMappings.LEOPARDMON_NX,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    nxDlc: true,
...
export const OMNIMON_NX: Digimon = {
  ...
  skills: skillMappings.OMNIMON_NX,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    nxDlc: true,
...
export const GALLANTMON_NX: Digimon = {
  ...
  skills: skillMappings.GALLANTMON_NX,
  digivolvesFrom: [],
  digivolvesTo: [],
  digivolutionRequirements: {
    nxDlc: true,
...
function digivolvesTo(start: Digimon, end: Digimon) {
  //update start
  if (!start.digivolvesTo) start.digivolvesTo = [];
  start.digivolvesTo.push(end);

  //update end
  if (!end.digivolvesFrom) end.digivolvesFrom = [];
...
digivolvesTo(MEGAKABUTERIMON, GRANKUWAGAMON);
digivolvesTo(MEGAKABUTERIMON, HERCULESKABUTERIMON);
digivolvesTo(MEGAKABUTERIMON, MAGNADRAMON);

digivolvesTo(ARCADIAMON_ULTIMATE, ARCADIAMON_MEGA);
digivolvesTo(ARCADIAMON_ULTIMATE, DIABOROMON);
digivolvesTo(ARCADIAMON_ULTIMATE, CREEPYMON);

digivolvesTo(ANTYLAMON, KERPYMON_BLK);
digivolvesTo(ANTYLAMON, KERPYMON_GOOD);
digivolvesTo(ANTYLAMON, DIANAMON);
digivolvesTo(ANTYLAMON, DIABOROMON);

digivolvesTo(ANDROMON, CRANIAMON);
digivolvesTo(ANDROMON, TIGERVESPAMON);
digivolvesTo(ANDROMON, HIANDROMON);

digivolvesTo(METEORMON, EBEMON);
digivolvesTo(METEORMON, DIANAMON);
digivolvesTo(METEORMON, METALETEMON);

digivolvesTo(INFERMON, ARCADIAMON_MEGA);
digivolvesTo(INFERMON, VENOMMYOTISMON);
digivolvesTo(INFERMON, DIABOROMON);
digivolvesTo(INFERMON, BEELZEMON);

digivolvesTo(MYOTISMON, ARCADIAMON_MEGA);
digivolvesTo(MYOTISMON, VENOMMYOTISMON);
digivolvesTo(MYOTISMON, GRANDRACMON);
digivolvesTo(MYOTISMON, BARBAMON);
digivolvesTo(MYOTISMON, PIEDMON);

digivolvesTo(WINGDRAMON, ULFORCEVEEDRAMON);
digivolvesTo(WINGDRAMON, SLAYERDRAMON);
digivolvesTo(WINGDRAMON, DYNASMON);

digivolvesTo(BURNINGGREYMON, KAISERGREYMON);

digivolvesTo(AEROVEEDRAMON, ULFORCEVEEDRAMON);
digivolvesTo(AEROVEEDRAMON, GOLDRAMON);
digivolvesTo(AEROVEEDRAMON, DYNASMON);
digivolvesTo(AEROVEEDRAMON, RAVEMON);

digivolvesTo(ETEMON, KINGETEMON);
digivolvesTo(ETEMON, PILEVOLCAMON);
digivolvesTo(ETEMON, PIEDMON);
digivolvesTo(ETEMON, PLATINUMNUMEMON);
digivolvesTo(ETEMON, METALETEMON);

digivolvesTo(ANGEWOMON, VALKYRIMON);
digivolvesTo(ANGEWOMON, OPHANIMON);
digivolvesTo(ANGEWOMON, MAGNADRAMON);
digivolvesTo(ANGEWOMON, MASTEMON);

digivolvesTo(OKUWAMON, GRANKUWAGAMON);
digivolvesTo(OKUWAMON, DIABOROMON);
digivolvesTo(OKUWAMON, HERCULESKABUTERIMON);

digivolvesTo(GARUDAMON, VARODURUMON);
digivolvesTo(GARUDAMON, GRYPHONMON);
digivolvesTo(GARUDAMON, JUSTIMON);
digivolvesTo(GARUDAMON, HOUOUMON);
digivolvesTo(GARUDAMON, RAVEMON);

digivolvesTo(KENDOGARURUMON, MAGNAGARURUMON);

digivolvesTo(GIGADRAMON, GROUNDLOCOMON);
digivolvesTo(GIGADRAMON, DARKDRAMON);
digivolvesTo(GIGADRAMON, DORUGORAMON);
digivolvesTo(GIGADRAMON, MACHINEDRAMON);
digivolvesTo(GIGADRAMON, MEGIDRAMON);
digivolvesTo(GIGADRAMON, METALSEADRAMON);

digivolvesTo(CATCHMAMEMON, JUSTIMON);
digivolvesTo(CATCHMAMEMON, PUPPETMON);
digivolvesTo(CATCHMAMEMON, PRINCEMAMEMON);

digivolvesTo(CANNONBEEMON, GROUNDLOCOMON);
digivolvesTo(CANNONBEEMON, MEGAGARGOMON);
digivolvesTo(CANNONBEEMON, TIGERVESPAMON);

digivolvesTo(GROUNDRAMON, VIKEMON);
digivolvesTo(GROUNDRAMON, BREAKDRAMON);
digivolvesTo(GROUNDRAMON, MEGIDRAMON);

digivolvesTo(GRAPLEOMON, SABERLEOMON);
digivolvesTo(GRAPLEOMON, LEOPARDMON);
digivolvesTo(GRAPLEOMON, PILEVOLCAMON);
digivolvesTo(GRAPLEOMON, BANCHOLEOMON);

digivolvesTo(GRADEMON, ALPHAMON);
digivolvesTo(GRADEMON, TIGERVESPAMON);
digivolvesTo(GRADEMON, DURANDAMON);
digivolvesTo(GRADEMON, DORUGORAMON);
digivolvesTo(GRADEMON, OURYUMON);

digivolvesTo(CRESCEMON, KERPYMON_GOOD);
digivolvesTo(CRESCEMON, KENTAUROSMON);
digivolvesTo(CRESCEMON, DIANAMON);

digivolvesTo(CYBERDRAMON, ALPHAMON);
digivolvesTo(CYBERDRAMON, JUSTIMON);
digivolvesTo(CYBERDRAMON, TITAMON);

digivolvesTo(SHAKKOUMON, VIKEMON);
digivolvesTo(SHAKKOUMON, CHAOSGALLANTMON);
digivolvesTo(SHAKKOUMON, KERPYMON_GOOD);

digivolvesTo(CHERRYMON, KUZUHAMON);
digivolvesTo(CHERRYMON, GRANKUWAGAMON);
digivolvesTo(CHERRYMON, PUPPETMON);

digivolvesTo(SILPHYMON, VALKYRIMON);
digivolvesTo(SILPHYMON, GRYPHONMON);
digivolvesTo(SILPHYMON, SAKUYAMON);
digivolvesTo(SILPHYMON, DYNASMON);
digivolvesTo(SILPHYMON, HOUOUMON);

digivolvesTo(SUPERSTARMON, GANKOOMON);
digivolvesTo(SUPERSTARMON, JUSTIMON);
digivolvesTo(SUPERSTARMON, PLATINUMNUMEMON);

digivolvesTo(SKULLGREYMON, SHINEGREYMON);
digivolvesTo(SKULLGREYMON, TITAMON);
digivolvesTo(SKULLGREYMON, CREEPYMON);

digivolvesTo(SKULLSATAMON, GRANDRACMON);
digivolvesTo(SKULLSATAMON, DIABOROMON);
digivolvesTo(SKULLSATAMON, CREEPYMON);

digivolvesTo(ZUDOMON, VIKEMON);
digivolvesTo(ZUDOMON, PLESIOMON);
digivolvesTo(ZUDOMON, MARINEANGEMON);
digivolvesTo(ZUDOMON, METALGARURUMON);

digivolvesTo(SAVIORHUCKMON, VALKYRIMON);
digivolvesTo(SAVIORHUCKMON, JESMON);
digivolvesTo(SAVIORHUCKMON, SLAYERDRAMON);

digivolvesTo(TAOMON, KUZUHAMON);
digivolvesTo(TAOMON, SAKUYAMON);
digivolvesTo(TAOMON, DIANAMON);

digivolvesTo(DRAGOMON, EBEMON);
digivolvesTo(DRAGOMON, NEPTUNEMON);
digivolvesTo(DRAGOMON, LEVIAMON);

digivolvesTo(CHIRINMON, KENTAUROSMON);
digivolvesTo(CHIRINMON, SERAPHIMON);
digivolvesTo(CHIRINMON, METALGARURUMON);

digivolvesTo(DINOBEEMON, IMPERIALDRAMON_DM);
digivolvesTo(DINOBEEMON, GRANKUWAGAMON);

digivolvesTo(DIGITAMAMON, TITAMON);
digivolvesTo(DIGITAMAMON, BELPHEMON_SM);
digivolvesTo(DIGITAMAMON, MINERVAMON);

digivolvesTo(SKULLMERAMON, GANKOOMON);
digivolvesTo(SKULLMERAMON, BEELZEMON);
digivolvesTo(SKULLMERAMON, BOLTMON);

digivolvesTo(DURAMON, JESMON);
digivolvesTo(DURAMON, TIGERVESPAMON);
digivolvesTo(DURAMON, DURANDAMON);

digivolvesTo(SHOGUNGEKOMON, VIKEMON);
digivolvesTo(SHOGUNGEKOMON, KINGETEMON);
digivolvesTo(SHOGUNGEKOMON, PLESIOMON);
digivolvesTo(SHOGUNGEKOMON, LEVIAMON);

digivolvesTo(TRICERAMON, GRANKUWAGAMON);
digivolvesTo(TRICERAMON, SABERLEOMON);
digivolvesTo(TRICERAMON, BREAKDRAMON);

digivolvesTo(DORUGREYMON, ALPHAMON);
digivolvesTo(DORUGREYMON, KENTAUROSMON);
digivolvesTo(DORUGREYMON, DORUGORAMON);

digivolvesTo(KNIGHTMON, CRANIAMON);
digivolvesTo(KNIGHTMON, DURANDAMON);
digivolvesTo(KNIGHTMON, LEOPARDMON);
digivolvesTo(KNIGHTMON, CRUSADERMON);

digivolvesTo(DATAMON, GROUNDLOCOMON);
digivolvesTo(DATAMON, MACHINEDRAMON);
digivolvesTo(DATAMON, METALGARURUMON_BLK);

digivolvesTo(PAILDRAMON, IMPERIALDRAMON_DM);

digivolvesTo(PANJYAMON, SABERLEOMON);
digivolvesTo(PANJYAMON, BANCHOLEOMON);
digivolvesTo(PANJYAMON, MIRAGEGAOGAMON);

digivolvesTo(PANDAMON, KINGETEMON);
digivolvesTo(PANDAMON, JUSTIMON);
digivolvesTo(PANDAMON, BANCHOLEOMON);

digivolvesTo(PUMPKINMON, PUPPETMON);
digivolvesTo(PUMPKINMON, BOLTMON);
digivolvesTo(PUMPKINMON, ROSEMON);

digivolvesTo(PIXIMON, OPHANIMON);
digivolvesTo(PIXIMON, HOUOUMON);
digivolvesTo(PIXIMON, MARINEANGEMON);

digivolvesTo(HIPPOGRYPHONMON, VARODURUMON);
digivolvesTo(HIPPOGRYPHONMON, GRYPHONMON);
digivolvesTo(HIPPOGRYPHONMON, SERAPHIMON);

digivolvesTo(PHANTOMON, VENOMMYOTISMON);
digivolvesTo(PHANTOMON, TITAMON);
digivolvesTo(PHANTOMON, BARBAMON);

digivolvesTo(BLACKKINGNUMEMON, PLATINUMNUMEMON);
digivolvesTo(BLACKKINGNUMEMON, PRINCEMAMEMON);
digivolvesTo(BLACKKINGNUMEMON, METALETEMON);

digivolvesTo(BLUEMERAMON, DARKDRAMON);
digivolvesTo(BLUEMERAMON, CREEPYMON);
digivolvesTo(BLUEMERAMON, BARBAMON);
digivolvesTo(BLUEMERAMON, BOLTMON);

digivolvesTo(VADEMON, EBEMON);
digivolvesTo(VADEMON, HIANDROMON);
digivolvesTo(VADEMON, HERCULESKABUTERIMON);

digivolvesTo(WHAMON, NEPTUNEMON);
digivolvesTo(WHAMON, PLESIOMON);
digivolvesTo(WHAMON, MARINEANGEMON);
digivolvesTo(WHAMON, METALSEADRAMON);

digivolvesTo(MAGNAANGEMON, VALKYRIMON);
digivolvesTo(MAGNAANGEMON, GOLDRAMON);
digivolvesTo(MAGNAANGEMON, SHINEGREYMON);
digivolvesTo(MAGNAANGEMON, SERAPHIMON);
digivolvesTo(MAGNAANGEMON, CRUSADERMON);

digivolvesTo(VOLCANOMON, GANKOOMON);
digivolvesTo(VOLCANOMON, PILEVOLCAMON);
digivolvesTo(VOLCANOMON, METALETEMON);

digivolvesTo(MATADORMON, VENOMMYOTISMON);
digivolvesTo(MATADORMON, GRANDRACMON);
digivolvesTo(MATADORMON, PIEDMON);

digivolvesTo(MACHGAOGAMON, MEGAGARGOMON);
digivolvesTo(MACHGAOGAMON, BANCHOLEOMON);
digivolvesTo(MACHGAOGAMON, MIRAGEGAOGAMON);
digivolvesTo(MACHGAOGAMON, MERUKIMON);

digivolvesTo(MAMEMON, WARGREYMON);
digivolvesTo(MAMEMON, PUPPETMON);
digivolvesTo(MAMEMON, PRINCEMAMEMON);

digivolvesTo(MEGASEADRAMON, NEPTUNEMON);
digivolvesTo(MEGASEADRAMON, PLESIOMON);
digivolvesTo(MEGASEADRAMON, METALSEADRAMON);
digivolvesTo(MEGASEADRAMON, LEVIAMON);

digivolvesTo(MEGADRAMON, ULFORCEVEEDRAMON);
digivolvesTo(MEGADRAMON, GOLDRAMON);
digivolvesTo(MEGADRAMON, BLACKWARGREYMON);
digivolvesTo(MEGADRAMON, MACHINEDRAMON);
digivolvesTo(MEGADRAMON, MEGIDRAMON);

digivolvesTo(WARGROWLMON, CHAOSGALLANTMON);
digivolvesTo(WARGROWLMON, DARKDRAMON);
digivolvesTo(WARGROWLMON, GALLANTMON);
digivolvesTo(WARGROWLMON, MEGIDRAMON);
digivolvesTo(WARGROWLMON, RUSTTYRANOMON);

digivolvesTo(METALGREYMON, WARGREYMON);
digivolvesTo(METALGREYMON, GAIOMON);
digivolvesTo(METALGREYMON, RUSTTYRANOMON);

digivolvesTo(METALGREYMON_BLUE, WARGREYMON);
digivolvesTo(METALGREYMON_BLUE, GAIOMON);
digivolvesTo(METALGREYMON_BLUE, KERPYMON_BLK);
digivolvesTo(METALGREYMON_BLUE, BLACKWARGREYMON);

digivolvesTo(METALTYRANNOMON, GALLANTMON);
digivolvesTo(METALTYRANNOMON, BLACKWARGREYMON);
digivolvesTo(METALTYRANNOMON, BREAKDRAMON);
digivolvesTo(METALTYRANNOMON, RUSTTYRANOMON);

digivolvesTo(METALMAMEMON, EBEMON);
digivolvesTo(METALMAMEMON, HIANDROMON);
digivolvesTo(METALMAMEMON, PRINCEMAMEMON);

digivolvesTo(MONZAEMON, SABERLEOMON);
digivolvesTo(MONZAEMON, SAKUYAMON);
digivolvesTo(MONZAEMON, MINERVAMON);

digivolvesTo(CROWMON, VARODURUMON);
digivolvesTo(CROWMON, KUZUHAMON);
digivolvesTo(CROWMON, MINERVAMON);
digivolvesTo(CROWMON, RAVEMON);
digivolvesTo(CROWMON, OURYUMON);

digivolvesTo(RIZEGREYMON, GAIOMON);
digivolvesTo(RIZEGREYMON, SHINEGREYMON);
digivolvesTo(RIZEGREYMON, SLAYERDRAMON);

digivolvesTo(LILAMON, LILITHMON);
digivolvesTo(LILAMON, ROSEMON);
digivolvesTo(LILAMON, LOTOSMON);

digivolvesTo(RAPIDMON, MEGAGARGOMON);
digivolvesTo(RAPIDMON, TIGERVESPAMON);
digivolvesTo(RAPIDMON, METALGARURUMON_BLK);

digivolvesTo(LILLYMON, MAGNADRAMON);
digivolvesTo(LILLYMON, ROSEMON);
digivolvesTo(LILLYMON, LOTOSMON);

digivolvesTo(LUCEMON_FM, LUCEMON_SM);

digivolvesTo(LADYDEVIMON, MASTEMON);
digivolvesTo(LADYDEVIMON, LILITHMON);
digivolvesTo(LADYDEVIMON, LOTOSMON);

digivolvesTo(WEREGARURUMON, MIRAGEGAOGAMON);
digivolvesTo(WEREGARURUMON, METALGARURUMON);
digivolvesTo(WEREGARURUMON, METALGARURUMON_BLK);

digivolvesTo(WEREGARURUMON_BLK, BANCHOLEOMON);
digivolvesTo(WEREGARURUMON_BLK, MINERVAMON);
digivolvesTo(WEREGARURUMON_BLK, METALGARURUMON_BLK);
digivolvesTo(WEREGARURUMON_BLK, MERUKIMON);

digivolvesTo(WISEMON, VENOMMYOTISMON);
digivolvesTo(WISEMON, PIEDMON);
digivolvesTo(WISEMON, BELPHEMON_SM);
//#endregion

//#region Mega to Ultra
digivolvesTo(ARCADIAMON_MEGA, ARCADIAMON_ULTRA);

digivolvesTo(ALPHAMON, ALPHAMON_OURYUKEN);

digivolvesTo(IMPERIALDRAMON_DM, IMPERIALDRAMON_FM);
digivolvesTo(IMPERIALDRAMON_DM, IMPERIALDRAMON_PM);

digivolvesTo(IMPERIALDRAMON_FM, IMPERIALDRAMON_DM);

digivolvesTo(VARODURUMON, CHAOSMON_VA);

digivolvesTo(WARGREYMON, OMNIMON);

digivolvesTo(KAISERGREYMON, SUSANOMON);

digivolvesTo(SHINEGREYMON, SHINEGREYMON_BM);

digivolvesTo(SLAYERDRAMON, EXAMON);

digivolvesTo(DARKDRAMON, CHAOSMON);

digivolvesTo(DIABOROMON, ARMAGEDDEMON);

digivolvesTo(GALLANTMON, GALLANTMON_CM);

digivolvesTo(LEOPARDMON, LEOPARDMON_LM);
digivolvesTo(LEOPARDMON_LM, LEOPARDMON);

digivolvesTo(BANCHOLEOMON, CHAOSMON);
digivolvesTo(BANCHOLEOMON, CHAOSMON_VA);

digivolvesTo(PIEDMON, APOCALYMON);

digivolvesTo(PUPPETMON, APOCALYMON);

digivolvesTo(BLACKWARGREYMON, OMNIMON_ZWART);

digivolvesTo(BREAKDRAMON, EXAMON);

digivolvesTo(HERCULESKABUTERIMON, TYRANTKABUTERIMON);

digivolvesTo(BEELZEMON, BEELZEMON_BM);

digivolvesTo(BELPHEMON_SM, BELPHEMON_RM);

digivolvesTo(MAGNAGARURUMON, MAGNAGARURUMON_SV);
digivolvesTo(MAGNAGARURUMON, SUSANOMON);

digivolvesTo(MAGNAGARURUMON_SV, MAGNAGARURUMON);

digivolvesTo(MIRAGEGAOGAMON, MIRAGEGAOGAMON_BM);

digivolvesTo(MACHINEDRAMON, CHAOSDRAMON);
digivolvesTo(MACHINEDRAMON, APOCALYMON);

digivolvesTo(METALGARURUMON, OMNIMON);

digivolvesTo(METALGARURUMON_BLK, OMNIMON_ZWART);

digivolvesTo(METALSEADRAMON, APOCALYMON);

digivolvesTo(RAVEMON, RAVEMON_BM);

digivolvesTo(ROSEMON, ROSEMON_BM);
//#endregion

//#region Other
digivolvesTo(BELPHEMON_RM, BELPHEMON_SM);
